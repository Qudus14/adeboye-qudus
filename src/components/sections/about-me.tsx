...
import SagarFullPose from '@/app/assets/files/img_2.png';
      ...
      <div className="flex w-full flex-col justify-between gap-12 md:flex-row">
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            ...
            who specializes in frontend development (React.js & Next.js). I am
          ...
          <Typography>
            ...
            hovering around on twitter or on facebook, witnessing the
          ...
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            ...
            <ul className="flex list-inside list-disc flex-col gap-2">
              ...
              <Typography component="li">Aspiring Football Coach</Typography>
            </ul>
          </div>
          <Typography>
